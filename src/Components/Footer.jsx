        ...
        <div className="flex items-center space-x-3 group">
              ...
              <span className="text-xl sm:text-2xl font-bold text-white">
                NEXA
                    ...
                    <div className="flex mt-4 space-x-4 justify-center lg:justify-start sm:mt-0 ">
                        <a href="https://www.twitter.com"  className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#33CCFF] hover:bg-gray-900">
                        ...
                        <a href="https://www.instagram.com"  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                        ">
                        ...
                        <a href="https://www.facebook.com"  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
                ...
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                    ...
                    <ul className="text-gray-600  transition-all duration-500">
                        ...
                        <li >61-A, Elm street, America, India.</li>
                    </ul>
                </div>
                ...
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:order-last sm:col-span-4 md:col-span-4 lg:order-none lg:col-span-1">
                    ...
                    <ul className="text-gray-600 transition-all duration-500  ">
                        <li className="mb-6"><Link to="/home"  className="text-gray-600 hover:text-gray-900">Home</Link></li>
                        <li className="mb-6"><Link to="/feature"  className=" text-gray-600 hover:text-gray-900">About</Link></li>
                        <li className="mb-6"><Link to="/contact"  className=" text-gray-600 hover:text-gray-900">Pricing</Link></li>
                        <li className="sm:mb-6"><Link to="/about"  className=" text-gray-600 hover:text-gray-900">Features</Link></li>
                    </ul>
                </div>
              
                <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2 ">
                    <h4 className="text-lg text-center text-gray-900 font-medium mb-7 lg:text-left">Newsletter</h4>
                    <div className="flex flex-col items-center lg:items-start">
                        <input type="text" className="w-full h-12 border border-gray-300 rounded-full py-2.5 px-5 shadow-sm text-gray-800 mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-gray-500"  placeholder="Your email here.."/>
                        <button type="submit" className="h-11 py-3 px-6 bg-indigo-600 transition-all duration-500 shadow-md rounded-full text-sm text-white font-semibold w-fit hover:bg-indigo-700">Subscribe</button>
                    </div>
                </div>
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">NEXA</a> 2024, All rights reserved.</span>
